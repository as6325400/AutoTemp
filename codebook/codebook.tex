...
\setCJKmainfont[Path=./fonts/]{NotoSansMonoCJKtc-VF.ttf}    %中文字型
\setCJKmonofont[Path=./fonts/]{NotoSansMonoCJKtc-VF.ttf}
...
\fancyhead[L]{National  Tsing  Hua  University  DreamingNoBubble}
\fancyhead[R]{\thepage}
